...
"}")
        ...
        self.label_title.setStyleSheet(u"color: rgba(168, 166, 255, 255);")
...
"QProgressBar::chunk{\n"
"	border-radius: 10px;\n"
"	background-color: qlineargradient(spread:pad, x1:0, y1:0.511364, x2:1, y2:0.523, stop:0 rgba(254, 121, 199, 255), stop:1 rgba(168, 166, 255, 255));\n"
"}")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_title.setText(QCoreApplication.translate("SplashScreen", u"Калькулятор марковских процессов", None))
        self.label_loading.setText(QCoreApplication.translate("SplashScreen", u"Загрузка...", None))
        self.label_credits.setText(QCoreApplication.translate("SplashScreen", u"<strong>By</strong>: Seleznev Egor", None))
    # retranslateUi